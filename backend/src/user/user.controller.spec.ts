...
describe('UserController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      .useValue({ canActivate: () => true }) // permitimos pasar siempre
  ...
  describe('Swagger Decorators', () => {
    it('should have ApiTags decorator', () => {
      const decorators = Reflect.getMetadata('swagger/apiTags', UserController);
      expect(decorators).toEqual(['Users']);
    });

    it('should have ApiBearerAuth decorator', () => {
      const decorators = Reflect.getMetadata('swagger/apiBearerAuth', UserController);
